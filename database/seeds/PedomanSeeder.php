...
class PedomanSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		$filename = 'pedoman/dokumen/'.str_random(3).'-'.str_replace(' ', '_', end($name)).'.'.explode('.', $path)[1];
		Storage::put($filename, file_get_contents($path));
		$pedoman = new Pedoman;
		$pedoman->user_id = 1;
		$pedoman->judul = 'KAK BIMTEK PETUGAS PENGELOLA PASAR 2016 - Revisi 10022016';
		...
		$pedoman = new Pedoman;
		$pedoman->user_id = 1;
		$pedoman->judul = 'KAK FORUM ADVOKASI KOMITMKEN PEMDA DAN LINTAS SEKTOR 2016 - Revisi 10022016';
		...
		$pedoman = new Pedoman;
		$pedoman->user_id = 1;
		$pedoman->judul = 'KAK KAMPANYE PASAR AMAN DARI BAHAN BERBAHAYA 2016 - Revisi 10022016';
		...
		$pedoman = new Pedoman;
		$pedoman->user_id = 1;
		$pedoman->judul = 'KAK PENYULUHAN PADA KOMUNITAS PASAR 2016 - Revisi 10022016';
