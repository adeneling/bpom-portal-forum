...
class ProgramDokumenSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		$dokumen->user_id = 1;
		$dokumen->nama = 'KAK BIMTEK PETUGAS PENGELOLA PASAR 2016';
		...
		$pedoman->user_id = 1;
		$pedoman->nama = 'KAK FORUM ADVOKASI KOMITMKEN PEMDA DAN LINTAS SEKTOR 2016';
		...
		$pedoman = new ProgramDokumen;
		$pedoman->user_id = 1;
		$pedoman->nama = 'KAK KAMPANYE PASAR AMAN DARI BAHAN BERBAHAYA 2016';
		...
		$pedoman = new ProgramDokumen;
		$pedoman->user_id = 1;
		$pedoman->nama = 'KAK PENYULUHAN PADA KOMUNITAS PASAR 2016';
