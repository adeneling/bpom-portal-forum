				...
				<div class="media">
					...
					<div class="media-body">
						...
						<span class="text-muted">
							<a href="{{ asset($pedoman->media_dokumen) }}" class="btn btn-primary"> Download</a> | <a href="{{ route('pedoman.dokumen.show', encrypt($pedoman->id)) }}" class="btn btn-success" target="_blank"> Preview</a>
						</span>
					</div>
				</div>
			</li>
