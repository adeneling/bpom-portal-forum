		...
		<div class="container">
			<div class="row">
				<div class="col s12 m12 l12">
					...
					{!! Breadcrumbs::render('admin.pengguna-forum.edit', $user) !!}
				</div>
			</div>
		</div>
	</div>
		...
		<div class="section">
			<div id="input-fields">
				<div class="row">
					...
					@endif
					{!! Form::model($user, ['route' => ['admin.pengguna-forum.update', encrypt($user->id)], 'class' => 'col s12', 'files' => true, 'method' => 'PUT']) !!}
						<div class="row">
